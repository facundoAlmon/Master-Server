...
var map = {
	"app/dispositivos/dispositivos.module": [
...
module.exports = "<mat-toolbar color=\"primary\">\n  <button type=\"button\" mat-icon-button (click)=\"sidenav.toggle()\">\n    <mat-icon>menu</mat-icon>\n  </button>\n  <span>Control ESP</span>\n</mat-toolbar>\n<mat-sidenav-container class=\"example-container\" style=\"min-height:500px\">\n  \n  <mat-sidenav #sidenav class=\"example-sidenav\">\n    <mat-nav-list>\n        <mat-list-item routerLink=\"/\" (click)=\"sidenav.close()\">\n            <mat-icon mat-list-icon>folder</mat-icon>\n            <h4 mat-line>Inicio</h4>\n          </mat-list-item>\n      <mat-list-item routerLink=\"dispositivos\" (click)=\"sidenav.close()\">\n        <mat-icon mat-list-icon>folder</mat-icon>\n        <h4 mat-line>Dispositivos</h4>\n      </mat-list-item>\n      <mat-list-item routerLink=\"graficos\" (click)=\"sidenav.close()\">\n        <mat-icon mat-list-icon>folder</mat-icon>\n        <h4 mat-line>Graficos</h4>\n      </mat-list-item>\n    </mat-nav-list>\n  </mat-sidenav>\n  <div class=\"example-sidenav-content\">\n    <router-outlet></router-outlet>\n  </div>\n</mat-sidenav-container>"
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__espservice_service__ = __webpack_require__("../../../../../src/app/espservice.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__models_Device__ = __webpack_require__("../../../../../src/app/_models/Device.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__app_material_app_material_module__ = __webpack_require__("../../../../../src/app/app-material/app-material.module.ts");
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["NgModule"])({
            ...
            imports: [
                ...
                __WEBPACK_IMPORTED_MODULE_8__app_material_app_material_module__["a" /* AppMaterialModule */]
            ],
            providers: [__WEBPACK_IMPORTED_MODULE_6__espservice_service__["a" /* EspserviceService */],
                __WEBPACK_IMPORTED_MODULE_7__models_Device__["a" /* Device */]
            ],
...
/***/ "../../../../../src/app/espservice.service.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return EspserviceService; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("../../../core/esm5/core.js");
...
var EspserviceService = /** @class */ (function () {
    function EspserviceService(http) {
        this.http = http;
        this.tempValues = [];
        this.tempLabels = [];
    ...
    EspserviceService.prototype.getIRCodes = function () {
        return this.http.get(this.url + '/api/ir/codes').map(function (response) { return response.json(); });
    };
    EspserviceService.prototype.sendIRCodes = function (deviceID, codeID) {
        return this.http.post(this.url + '/api/ir/sender/send', { _id: codeID, deviceID: deviceID }).map(function (response) { return response.json(); });
    };
    EspserviceService.prototype.getDHTInfo = function (deviceID) {
        return this.http.get(this.url + '/api/dht/' + deviceID).map(function (response) { return response.json(); });
    };
    EspserviceService.prototype.getLuzInfo = function (deviceID) {
        return this.http.get(this.url + '/api/luz/' + deviceID).map(function (response) { return response.json(); });
    };
    EspserviceService.prototype.getHistorialSensor = function (deviceID, dateFrom, dateTo) {
        return this.http.get(this.url + '/api/dht/historial/' + deviceID + "?from=" + dateFrom + "&to=" + dateTo).map(function (response) { return response.json(); });
    };
    EspserviceService.prototype.switchRelay = function (deviceID, value) {
        if (value) {
            return this.http.get(this.url + '/api/relay/on/' + deviceID).map(function (response) { return response.json(); });
        }
        else {
            return this.http.get(this.url + '/api/relay/off/' + deviceID).map(function (response) { return response.json(); });
        }
    };
    EspserviceService = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Injectable"])(),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__angular_http__["a" /* Http */]])
    ], EspserviceService);
    return EspserviceService;
}());
